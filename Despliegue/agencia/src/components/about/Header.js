...
const navigation = {
  ...
  social: [
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/garciaafelipe_/',
      icon: (props) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/GarciaFelipe1',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
    name: "LinkedIn",
    href: "https://www.linkedin.com/home/?originalSubdomain=ar",
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
...
function Header(){
    ...
    return(
      ...
      <div className="relative px-4 sm:px-6 lg:px-16 max-w-full">
          ...
          <div>
            <div>
              ...
              <p className="text-base sm:text-xl max-w-xl leading-relaxed text-gray-800 text-center md:text-left">
                We are an Argentine company founded in 2025, committed to driving business growth with innovative and tailored solutions.  
                Our mission is to help entrepreneurs and companies expand by offering a wide range of services designed to enhance their digital presence,  
                improve efficiency, and maximize their market impact.
              </p>
