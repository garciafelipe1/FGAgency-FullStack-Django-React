    ...
    return(
        ...
        <div className="relative px-4 sm:px-6 lg:px-8 max-w-full">
          <div className="mx-auto max-w-full xl:mx-12 xl:pt-40 xl:pb-64 lg:pt-40 lg:pb-48 pt-20 sm:pt-24 pb-24 sm:pb-12">
            <div>
              <div>
                <h1 className="text-2xl sm:text-4xl font-semibold tracking-tight pb-8 sm:pb-16 md:text-5xl">
                  Javascript Development
                </h1>
                <p className="mt-8 sm:mt-16 text-base sm:text-2xl max-w-3xl leading-7 sm:leading-8 text-black">
